...
public class SFAnalyzeItem implements AnalyzeItem {

    private final SimpleFeature feature;

    private final Geometry geometry;

    public SFAnalyzeItem(SimpleFeature feature) {
    ...
    private SFAnalyzeItem getItem(AnalyzeItem item) {
        if (!(item instanceof SFAnalyzeItem)) {
            throw new IllegalArgumentException("Unable to identify item object.");
        }
        return ((SFAnalyzeItem) item);
    }
